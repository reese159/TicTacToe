...
/**
 * Single player tic-tac-toe competent AI ONLY WAY TO WIN IS CREATE A FORKING
 * PATH
 * 
...
public class TicTacToeAIGame {
	...
	static JButton l1, l2, l3, l4, l5, l6, l7, l8, l9; // TODO: Make static? checking change...
	...
	/**
	 * Implementation of AI strategy Uses basic order-of-operations strategy
	 * 
	...
	/**
	 * Check if opposite corner has been played Block Corners
	 * 
	 * @param currBoard current game board
	 * @return Use/Don't Use
	 */
	...
	/**
	 * Check if corner has been played Play corners
	 * 
	 * @param currBoard current game board
	 * @return Use/Don't Use
	 */
	...
	/**
	 * Check if side has been played Play sides
	 * 
	 * @param currBoard current game board
	 * @return Use/Don't Use
	 */
	...
	public static void onePlayerGameButtonUpdate() {
		// Quit option for exit button
		onePlayerframe.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
	...
	public static void onePlayerGameOverButtonUpdate() {
		onePlayerVicotryFrame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		replay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				onePlayerframe.dispose();
				onePlayerVicotryFrame.dispose();
				// onePlayerCATFrame.dispose();
				// onePlayerGameGUI();
				onePlayerGUIInit();
